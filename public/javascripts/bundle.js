...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  insert: function insert(frag, index, prevEl, inDoc) {
	    if (frag.staggerCb) {
	  ...
	  remove: function remove(frag, index, total, inDoc) {
	    if (frag.staggerCb) {
	      frag.staggerCb.cancel();
	      frag.staggerCb = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  module.exports = {
	    bind: function bind() {
	      __webpack_require__(3).warn('v-ref:' + this.arg + ' must be used on a child ' + 'component. Found on <' + this.el.tagName.toLowerCase() + '>.');
	    }
	  };
	}
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
	...
	Watcher.prototype.set = function (value) {
	  ...
	  if (forContext && forContext.alias === this.expression) {
	    if (forContext.filters) {
	      process.env.NODE_ENV !== 'production' && _.warn('It seems you are using two-way binding on ' + 'a v-for alias (' + this.expression + '), and the ' + 'v-for has filters. This will not work properly. ' + 'Either remove the filters or use an array of ' + 'objects and bind to object properties instead.');
	      return;
	    }
	...
	function transcludeTemplate(el, options) {
	  ...
	  if (frag) {
	    ...
	    if (options.replace) {
	      ...
	      tag === 'component' || _.resolveAsset(options, 'components', tag) || replacer.hasAttribute('is') || replacer.hasAttribute(':is') || replacer.hasAttribute('v-bind:is') ||
	      // element directive
